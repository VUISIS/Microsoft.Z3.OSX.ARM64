...
namespace Microsoft.Z3
{
    ...
    public class Native
    {
        ...
        public class LIB
        {
            const string Z3_DLL_NAME = "libz3";
            ...
            [DllImport(Z3_DLL_NAME, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
            public extern static IntPtr Z3_get_numeral_binary_string(Z3_context a0, Z3_ast a1);
            ...
            [DllImport(Z3_DLL_NAME, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
            public extern static IntPtr Z3_goal_to_dimacs_string(Z3_context a0, Z3_goal a1, byte a2);
            ...
            [DllImport(Z3_DLL_NAME, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
            public extern static uint Z3_solver_propagate_register(Z3_context a0, Z3_solver a1, Z3_ast a2);

            [DllImport(Z3_DLL_NAME, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
            public extern static void Z3_solver_propagate_consequence(Z3_context a0, Z3_solver_callback a1, uint a2, [In] uint[] a3, uint a4, [In] uint[] a5, [In] uint[] a6, Z3_ast a7);
        ...
        public static string Z3_get_numeral_binary_string(Z3_context a0, Z3_ast a1) {
            IntPtr r = LIB.Z3_get_numeral_binary_string(a0, a1);
            Z3_error_code err = (Z3_error_code)LIB.Z3_get_error_code(a0);
            if (err != Z3_error_code.Z3_OK)
                throw new Z3Exception(Marshal.PtrToStringAnsi(LIB.Z3_get_error_msg(a0, (uint)err)));
            return Marshal.PtrToStringAnsi(r);
        ...
        public static string Z3_goal_to_dimacs_string(Z3_context a0, Z3_goal a1, byte a2) {
            IntPtr r = LIB.Z3_goal_to_dimacs_string(a0, a1, a2);
            Z3_error_code err = (Z3_error_code)LIB.Z3_get_error_code(a0);
            if (err != Z3_error_code.Z3_OK)
                throw new Z3Exception(Marshal.PtrToStringAnsi(LIB.Z3_get_error_msg(a0, (uint)err)));
            return Marshal.PtrToStringAnsi(r);
        ...
        public static uint Z3_solver_propagate_register(Z3_context a0, Z3_solver a1, Z3_ast a2) {
            uint r = LIB.Z3_solver_propagate_register(a0, a1, a2);
            Z3_error_code err = (Z3_error_code)LIB.Z3_get_error_code(a0);
            if (err != Z3_error_code.Z3_OK)
                throw new Z3Exception(Marshal.PtrToStringAnsi(LIB.Z3_get_error_msg(a0, (uint)err)));
            return r;
        ...
        public static void Z3_solver_propagate_consequence(Z3_context a0, Z3_solver_callback a1, uint a2, [In] uint[] a3, uint a4, [In] uint[] a5, [In] uint[] a6, Z3_ast a7) {
            LIB.Z3_solver_propagate_consequence(a0, a1, a2, a3, a4, a5, a6, a7);
            Z3_error_code err = (Z3_error_code)LIB.Z3_get_error_code(a0);
            if (err != Z3_error_code.Z3_OK)
                throw new Z3Exception(Marshal.PtrToStringAnsi(LIB.Z3_get_error_msg(a0, (uint)err)));
        }
